...
- `screens.lua` : rendu de tous les écrans. Il dessine la partie, le HUD, les menus, la boutique, la pause, le game over, ainsi que les aperçus des oiseaux, fonds et tuyaux. Le HUD de jeu affiche maintenant les pièces en haut à gauche avec l'icône `coin.png`.
